> `RHEL 7.3, /usr/share/doc/initscripts-9.49.37/sysconfig.txt`
...
## `/etc/sysconfig/network-scripts/ifup, ifdown`
...
## `/etc/sysconfig/network-scripts/rule-<interface-name>, rule6-<interface-name>`
