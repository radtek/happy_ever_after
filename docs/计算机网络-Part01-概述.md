...
![osi模型](./Pictures/计算机网络-01.png)

* 应用层

![应用层](./Pictures/osi-应用层.png)

* 表示层

![表示层](./Pictures/osi-表示层.png)

* 会话层

![会话层](./Pictures/osi-会话层.png)

* 传输层

![传输层](./Pictures/osi-传输层.png)

* 网络层

![网络层](./Pictures/osi-网络层.png)

* 数据链路层

![数据链路层](./Pictures/osi-数据链路层.png)

* 物理层

![物理层](./Pictures/osi-物理层.png)
